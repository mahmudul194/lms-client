...
export default function UnifiedDashboardPage() {
  ...
  // Restore role and tab on page refresh / load from URL & localStorage
  useEffect(() => {
    if (typeof window === "undefined") return;
    const sp = new URLSearchParams(window.location.search);
    const r = (sp.get("role") || localStorage.getItem("bim_user_role")) as any;
    const t = sp.get("tab") || localStorage.getItem("bim_active_tab");

    const validRole = ["student", "instructor", "admin"].includes(r) ? r : "student";
